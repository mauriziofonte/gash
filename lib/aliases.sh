...
__add_alias_if_supported "docker" "dcrm" "docker container prune"
...
__add_alias_if_supported "docker" "dnetrm" "docker network prune"
__add_alias_if_supported "docker" "dvolrm" "docker volume prune"
